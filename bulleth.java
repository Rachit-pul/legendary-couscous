...
public class bulleth extends JFrame implements KeyListener,Runnable{
  public int frameWidth = 500,frameHeight = 500,loc_x = 235,loc_y = 450,size_width=50,size_height=50,death=0,score=0,x=0,y=0;
  public int b,b1x=50,b1y=0,b2x=frameHeight,b2y=0,b3x=frameHeight%13,b3y=0,i;
	Thread t;
	Random r = new Random();
	public bulleth(){
